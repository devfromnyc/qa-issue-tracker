...
const STORAGE_KEY = "qa-tracker-demo-v2";
    ...
    issues: [
      {
        ...
        device: "mobile",
        browser: "safari",
        pageLink: "https://portal.example.com/login",
        issueAuthor: "Alex Chen",
        status: "new_issues",
        priority: "high",
        order: 0,
      ...
      },
      {
        ...
        device: "desktop",
        browser: "chrome",
        pageLink: "https://portal.example.com/dashboard",
        issueAuthor: "Sam Rivera",
        status: "in_progress",
        priority: "medium",
        order: 0,
        assigneeId: "demo-sam",
      ...
      },
      {
        ...
        pageName: "Board export",
        device: "desktop",
        browser: "all",
        pageLink: "",
        issueAuthor: "Jordan Lee",
        status: "ready_for_uat_qa",
        priority: "low",
        order: 0,
        assigneeId: null,
        assigneeName: null,
